...
while True:
    try:
        ...
        if opcion == 1:
            if usuario1 == None:
                print("No hay usuarios registrados, por favor ingrese usuario en la opción 2")
            else:
                        ...
                        if opcionMenu2 == 1:
                            while True:
                                ...
                                if numero.startswith("9") and len(numero) == 9 :
                                    ...
                                    print("Error, ingrese nuevamente, número debe comenzar con 9 y largo 9")
                        else:
                            if opcionMenu2 == 2:
                                while True:
                                ...
                                if opcionMenu2 == 3 :
                                    ...
                                    print("Debe ingresar una opción entre 1 y 3")
